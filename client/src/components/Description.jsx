    ...
    >
      ...
      <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
        ...
        <div>
            ...
            <p className='text-gray-600 mb-4'>Easi1y bring your ideas to life with our free AI
            ...
            <p className='text-gray-600'>Simply type in a text prompt, and our cutting-edge Al will generate high-
            ...
            Powered by advanced Al technology, the creative possibilities are limitless!</p>
        </div>
      </div>
    </motion.div>
  )
