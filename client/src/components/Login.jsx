  ...
  return (
    <div className='fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
      ...
      >
        ...
        {state !== 'Login' && <div className='border px-6 py-2 flex items-center rounded-full gap-2 mt-5'>
        ...
        <div className='border px-6 py-2 flex items-center rounded-full gap-2 mt-4'>
